...
<img src=".\RNN_Pic\\image-20240320141450146.png" alt="image-20240320141450146" style="zoom:50%;" />

​		**在RNN的经典架构中，网络通过一个特殊的循环结构将信息从一个处理步骤传递到下一个。这个循环结构通常被称为“隐藏层状态”或简单地称为“隐藏状态”。隐藏状态是RNN的记忆部分，它能够捕获并存储关于已处理序列元素的信息。**

- 原理流程

  <img src=".\RNN_Pic\\image-20240320142904019.png" alt="image-20240320142904019" style="zoom: 67%;" />
...
- 内部模型
  ...
  <img src=".\RNN_Pic\\图片11.png" style="zoom: 67%;" />

- 激活函数

  <img src=".\RNN_Pic\\图片22.png" style="zoom:80%;" />

#### 2.4.RNN模型输入输出关系

- 图示

  <img src=".\RNN_Pic\\图片20240610184427.png" style="zoom: 50%;" />
